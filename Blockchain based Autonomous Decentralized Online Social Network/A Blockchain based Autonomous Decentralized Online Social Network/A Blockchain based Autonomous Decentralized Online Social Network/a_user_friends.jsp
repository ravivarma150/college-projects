...
<% String user=request.getParameter("user"); %>
	    ...
	    <p align="center" class="style10">View <span class="style14"><%=user%>'s</span> Friends </p>
		  
		  
		  
		  
<table width="688" border="1.5" cellpadding="0" cellspacing="0" align="left">
            <tr bgcolor="#00FF33">
	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
                      <td height="53" bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><%=j%></div></td>
					 <%
					 
					 if(s2.equalsIgnoreCase(user))
					 {
					 %><td bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><a href="a_user_profile.jsp?user=<%=s3%>&type=<%="eight"%>"><%=s3%></a></div></td>
					 <%
					 }
					 if(s3.equalsIgnoreCase(user))
					 {
					 %><td bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><a href="a_user_profile.jsp?user=<%=s2%>&type=<%="eight"%>"><%=s2%></a></div></td>
					 <%
					 }
					 
					 %> 
					 
					  <td bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><%=s5%></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><%=s6%></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style19 style15 style16 style17"><%=s4%></div></td>
		  </tr>
        <%
