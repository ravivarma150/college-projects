...
def importdata(): 
    balance_data = pd.read_csv('F:/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/SOURCE CODE/Profile/dataset/dataset.txt')
...
def UserCheck(request):
    if request.method == 'POST':
      ...
      input+=data+"\n"
      f = open("F:/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/SOURCE CODE/Profile/dataset/test.txt", "w")
      f.write(input)
      f.close()
      test = pd.read_csv('F:/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/SOURCE CODE/Profile/dataset/test.txt')
...
def ViewTrain(request):
    if request.method == 'GET':
       ...
       data = pd.read_csv('F:/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/SOURCE CODE/Profile/dataset/dataset.txt')
