...
def importdata(): 
    balance_data = pd.read_csv('C:/Users/vkcse/OneDrive/Desktop/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/dataset.txt')
...
def UserCheck(request):
    if request.method == 'POST':
      ...
      input+=data+"\n"
      f = open("C:/Users/vkcse/OneDrive/Desktop/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/test.txt", "w")
      f.write(input)
      f.close()
      test = pd.read_csv('C:/Users/vkcse/OneDrive/Desktop/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/test.txt')
...
def ViewTrain(request):
    if request.method == 'GET':
       ...
       data = pd.read_csv('C:/Users/vkcse/OneDrive/Desktop/SIIET/fake_profile/Use_of_Artificial_Neural_Networks_to_Identify_FakeProfiles/dataset.txt')
